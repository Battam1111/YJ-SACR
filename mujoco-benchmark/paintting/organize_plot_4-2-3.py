...
# 使用示例
pdf_files = [ 
    "mujoco-benchmark/paintting/humanoidbench-paintting/plot_4-2/plot_4-2-3/h1hand-cubes-v0-middle.pdf", 
    "mujoco-benchmark/paintting/humanoidbench-paintting/plot_4-2/plot_4-2-3/h1hand-powerlift-v0-middle.pdf",
    "mujoco-benchmark/paintting/humanoidbench-paintting/plot_4-2/plot_4-2-3/h1hand-bookshelf_simple-v0-middle.pdf",
]

labels = ["(a) Cube", "(b) Powerlift", "(c) Bookshelf"]

output_path = "mujoco-benchmark/paintting/humanoidbench-paintting/plot_4-2/plot_4-2-3.pdf"
rows = 1  # 可以根据需要调整行数
cols = 3  # 可以根据需要调整列数

merge_pdfs_with_labels_dynamic(pdf_files, labels, output_path, rows, cols, dpi=300, label_font_size=30, spacing=40)
# merge_pdfs_with_labels_dynamic(pdf_files, labels, output_path, rows, cols, dpi=300, label_font_size=18)